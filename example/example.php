...
$params = [
		...
		"launch_presentation_width"             => "VALUE ... LaunchPresentationWidth",
		"launch_presentation_height"            => "VALUE ... LaunchPresentationHeight",
		...
		"lis_course_offering_sourcedid"        => "VALUE ... LisCourseOfferingsourcedid",
		"lis_course_section_sourcedid"         => "VALUE ... LisCourseSectionsourcedid",
		"custom_pet"                           => "dog",
